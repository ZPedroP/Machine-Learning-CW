...
<table>
  <tr>
    <td width="50%" align="center">
      <img src="https://github.com/ZPedroP/Machine-Learning-CW/blob/main/ICW/results/model_performance/combined_roc_curves_2025-03-21_00-27-10.png" width="95%">
      <p><em>Figure 1: ROC Curves (Baseline)</em></p>
    </td>
    <td width="50%" align="center">
      <img src="https://github.com/ZPedroP/Machine-Learning-CW/blob/main/ICW/results/model_performance/smote_pca/combined_roc_curves_2025-03-21_00-52-52_smote_pca.png" width="95%">
      <p><em>Figure 2: ROC Curves with SMOTE and PCA</em></p>
    </td>
  </tr>
  <tr>
    <td width="50%" align="center">
      <img src="https://github.com/ZPedroP/Machine-Learning-CW/blob/main/ICW/results/model_performance/pca/combined_roc_curves_2025-03-21_00-51-01_pca.png" width="95%">
      <p><em>Figure 3: ROC Curves with PCA</em></p>
    </td>
    <td width="50%" align="center">
      <img src="https://github.com/ZPedroP/Machine-Learning-CW/blob/main/ICW/results/model_performance/smote/combined_roc_curves_2025-03-21_00-46-31_smote.png" width="95%">
